 ...
 alt="Collaboration illustration" />
  ...
  <section className="sdgs-section">
    <div className="container">
      <div className="section-header">
        ...
        <p className="section-description">Our platform focuses particularly on SDG 17 (Partnerships), SDG 4 (Quality Education), and SDG 8 (Decent Work and Economic Growth).</p>
      </div>
  ...
  <section className="features-section">
    <div className="container">
      <div className="section-header">
        ...
        <p className="section-description">Our platform streamlines collaboration between individuals, teams, and NGOs with these powerful tools.</p>
      </div>
  ...
  <section className="how-it-works-section">
    <div className="container">
      <div className="section-header">
        ...
        <p className="section-description">A simple process to connect, collaborate and create impact together.</p>
      </div>
    ...
    <div className="container">
      <div className="section-header-with-link">
        <div>
          ...
          <p className="section-description">Join these impactful initiatives or start your own.</p>
        </div>
    ...
    <div className="container">
      <div className="section-header-with-link">
        <div>
          ...
          <p className="section-description">Collaborate with these organizations working toward SDGs.</p>
        </div>
  ...
  <section className="testimonials-section">
    <div className="container">
      <div className="section-header">
        ...
        <p className="section-description">Hear from volunteers and NGOs who have created impact together.</p>
      </div>
  ...
  <section className="cta-section">
    <div className="container">
      ...
      <p className="cta-description">Join Connect4Change today and start collaborating for the Sustainable Development Goals.</p>
